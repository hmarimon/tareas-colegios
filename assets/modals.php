  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="subject">Agregar Materia</h5>
      ...
      <div class="modal-body">
        <form action="./php/add-subject.php" method="POST">
          <div class="mb-3" hidden>
            <label for="subjectID" class="form-control">Materia ID</label>
...
<div class="modal fade mt-5" id="updateSubjectModal" tabindex="-1" aria-labelledby="updateSubject" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="updateSubject">Actualizar Materia</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="./php/update-subject.php" method="POST">
          <div class="mb-3" hidden>
            <label for="updateSubjectID" class="form-control">Materia ID</label>
