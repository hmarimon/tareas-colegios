...
<body>
  <div class="container">
    <div class="row mt-5 gap-2">
      ...
      <div class="col-12 col-lg-3 card bg-light p-3">

        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <button class="nav-link active" id="v-pills-home-tab" data-toggle="pill" data-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true"> <i class="fa-solid fa-home"></i> Inicio</button>
          <button class="nav-link" id="v-pills-pending-tab" data-toggle="pill" data-target="#v-pills-pending" type="button" role="tab" aria-controls="v-pills-pending" aria-selected="false"> <i class="fa-solid fa-clock"></i> Tareas Pendientes</button>
          <button class="nav-link" id="v-pills-in-progress-tab" data-toggle="pill" data-target="#v-pills-in-progress" type="button" role="tab" aria-controls="v-pills-in-progress" aria-selected="false"> <i class="fa-solid fa-bars-progress"></i> Tareas en Progreso</button>
          <button class="nav-link" id="v-pills-completed-tab" data-toggle="pill" data-target="#v-pills-completed" type="button" role="tab" aria-controls="v-pills-completed" aria-selected="false"> <i class="fa-solid fa-circle-check"></i> Tareas Completadas</button>
          <button class="nav-link" id="v-pills-subjects-tab" data-toggle="pill" data-target="#v-pills-subjects" type="button" role="tab" aria-controls="v-pills-subjects" aria-selected="false"> <i class="fa-solid fa-book"></i> Materias</button>
        </div>
      </div>
      <div class="col-12 col-lg-8 card">
        <div class="tab-content" id="v-pills-tabContent">
          <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
            ...
            <button type="button" class="btn btn-success m-3" data-toggle="modal" data-target="#taskModal">
                ...
                ?>
                  <tr>
                    ...
                    <td id="taskStatus-<?= $taskID ?>">
                      <?php
                      $badgeClass = $taskStatus == 'Pendiente' ? 'badge-dark' : ($taskStatus == 'En progreso' ? 'badge-primary' : 'badge-success');
                      ?>
              ...
              <tbody class="text-center">
                ...
                ?>
                  <tr>
                    ...
                    <td id="taskStatus-<?= $taskID ?>">
                      <span class="badge badge-dark"> <?php echo $taskStatus ?> </span>
                    </td>
                    <td>
                      <button type="button" class="btn btn-secondary" title="Update" onclick="update_task(<?php echo $taskID ?>)"><i class="fa-solid fa-pencil"></i></button>
                      <button type="button" class="btn btn-danger" title="Delete" onclick="delete_task(<?php echo $taskID ?>)"><i class="fa-solid fa-trash"></i></button>
              ...
              <tbody class="text-center">
                ...
                ?>
                  <tr>
                    ...
                    <td id="taskStatus-<?= $taskID ?>">
                      <span class="badge badge-primary"> <?php echo $taskStatus ?> </span>
                    </td>
                    <td>
                      <button type="button" class="btn btn-secondary" title="Update" onclick="update_task(<?php echo $taskID ?>)"><i class="fa-solid fa-pencil"></i></button>
                      <button type="button" class="btn btn-danger" title="Delete" onclick="delete_task(<?php echo $taskID ?>)"><i class="fa-solid fa-trash"></i></button>
              ...
              <tbody class="text-center">
                ...
                ?>
                  <tr>
                    ...
                    <td id="taskStatus-<?= $taskID ?>">
                      <span class="badge badge-success"> <?php echo $taskStatus ?> </span>
                    </td>
                    <td>
                      <button type="button" class="btn btn-secondary" title="Update" onclick="update_task(<?php echo $taskID ?>)"><i class="fa-solid fa-pencil"></i></button>
                      <button type="button" class="btn btn-danger" title="Delete" onclick="delete_task(<?php echo $taskID ?>)"><i class="fa-solid fa-trash"></i></button>
          ...
          <div class="tab-pane fade" id="v-pills-subjects" role="tabpanel" aria-labelledby="v-pills-subjects-tab">
            ...
            <button type="button" class="btn btn-success m-3" data-toggle="modal" data-target="#subjectModal">
              <i class="fa-solid fa-circle-plus"></i>
              Agregar Materia
            </button>
  ...
  <script>
    ...
    function delete_subject(id) {
      ...
      if (confirm("Deseas eliminar esta materia?")) {
        window.location = "./php/delete-subject.php?subject=" + id;
      }
    ...
    function delete_task(id) {
      ...
      if (confirm("Deseas eliminar esta tarea?")) {
        window.location = "./php/delete-task.php?task=" + id;
      }
